...
insert into ewaste_user (isactive,company,_role,email,phone,address,city,postcode,state,latitude,longitude, image_path, company_desc)
values (true, 'TGI Friday', 'volunteer', 'info@tgif.com', '+60 (03) 7663 8301' , 'One Utama, Bandar Utama', 'Petaling Jaya', 47400, 'Selangor', '3.1366612' ,'101.6217609',  './images/ewaste_user/tgif.png', 'Burger, Western')
