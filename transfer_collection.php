...
$sql = "update ewaste_trx set status = 'collected'
		where volunteer_id = " . $volunteer_id ." and recycler_id = " . $recycler_id ." and status = 'requested'" ;
...
header("Location: /collection.php?_id=" . $volunteer_id);
?>